# Contributing to Tecla 🤝

Thank you for your interest in contributing to **Tecla - The Command Butler**! We welcome contributions from developers of all skill levels and backgrounds. This guide will help you get started with contributing to the project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/tecla.git
   cd tecla
   ```

3. **Add the original repository** as a remote:
   ```bash
   git remote add upstream https://github.com/gi4nks/tecla.git
   ```
...
- Provide system information (OS, Go version, Tecla version)
...
#### 🔌 **Plugin Development**
- Create new plugins for the Tecla ecosystem
...
// Package commands provides CLI command implementations for Tecla.
...
- **Issues**: [GitHub Issues](https://github.com/gi4nks/tecla/issues)
- **Discussions**: [GitHub Discussions](https://github.com/gi4nks/tecla/discussions)

---

Thank you for contributing to Tecla! Your contributions help make command management better for everyone. 🚀
